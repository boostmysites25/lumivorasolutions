      ...
      <section className="text-white wrapper py-[3rem]">
        <div className="grid lg:grid-cols-2 gap-10 mt-7">
          ...
          >
            <div className="flex flex-col items-center lg:items-start gap-5">
              ...
              <p className="desc">
                At <b>Lumivora Solutions</b>, we leverage the transformative
        ...
        <div className="mt-[3rem]">
          ...
          <div className="flex flex-col-reverse md:grid grid-cols-2 gap-10 mt-7">
            ...
            >
              <p className="desc">
                At <b>Lumivora Solutions</b>, we don’t just build AI; we craft
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-7">
          ...
          >
            <div className="flex flex-col items-center lg:items-start gap-5">
              ...
              <p className="desc">
                At <b>Lumivora Solutions</b>, our team is at the heart of every
