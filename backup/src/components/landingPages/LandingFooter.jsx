        ...
        <div className="">
          ...
          <div className="flex items-center gap-3 mt-5">
            <Link
              ...
              className="w-[2rem] h-[2rem] rounded-full p-2 bg-secondary hover:bg-tertiary hover:-translate-y-1 transition-all duration-300 flex justify-center items-center"
            >
          ...
          <ul className="flex flex-col gap-3 mt-1">
            ...
            <li>
              <Link
                ...
                className="flex gap-3 text-white/70 hover:text-primary transition-colors duration-200"
              >
                <WhatsApp className="w-5 h-5 fill-green-500" />{" "}
                <span className="text-sm">{companyDetails.whatsapp}</span>
              </Link>
            </li>
          </ul>
        </div>
