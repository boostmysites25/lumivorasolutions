    ...
    <SectionWrapper className="relative overflow-hidden">
      ...
      <div className="relative z-10 wrapper text-center">
        ...
        >
          ...
          >
            Ready to Build Your
            <span className="text-accent"> Dream App?</span>
          </motion.h2>
          ...
          >
            Join hundreds of satisfied clients who have transformed their ideas into 
            successful mobile applications. Let's bring your vision to life!
          </motion.p>
