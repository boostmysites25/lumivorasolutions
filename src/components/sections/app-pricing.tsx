...
const plans = [
  {
    ...
    description: 'Perfect for simple mobile apps with basic functionality',
    features: [
  ...
  },
  {
    ...
    price: '$15,000',
    period: 'Starting from',
    description: 'Ideal for businesses looking for feature-rich mobile applications',
    features: [
  ...
  },
  {
    ...
    price: '$35,000',
    period: 'Starting from',
    description: 'Comprehensive solution for large-scale mobile applications',
    features: [
